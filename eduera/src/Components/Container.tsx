                ...
                <Box  w={{base:"100%",md:"70%"}} h={"100%"}  >
                    ...
                    <Flex w={"100%"}>
                        <Box lineHeight={"400%"} w={"50%"}>
                            <Text className='education' fontSize={"xl"}>Art and design</Text>
                            <Text className='education' fontSize={"xl"}>Bussiness and management</Text>
                            <Text className='education' fontSize={"xl"}>Natural and exact science</Text>
                            <Text className='education' fontSize={"xl"}>Jurisprudence</Text>
                            <Text className='education' fontSize={"xl"}>Tourism and hospitality</Text>
                            <Text className='education' fontSize={"xl"}>Economy</Text>
                        </Box>
                        <Box lineHeight={"400%"} w={"50%"}>
                            <Text className='education' fontSize={"xl"}>International relationships</Text>
                            <Text className='education' fontSize={"xl"}>Media and communication</Text>
                            <Text className='education' fontSize={"xl"}>Humanitarian science</Text>
                            <Text className='education' fontSize={"xl"}>Biology and Biomedicine</Text>
                            <Text className='education' fontSize={"xl"}>Social science</Text>
                            <Text className='education' fontSize={"xl"}>IT, Computer science</Text>
                        </Box>
                    </Flex>
                </Box>
            </Flex>
            <Box w={"90%"} m={"auto"} >
                ...
                <Grid templateColumns={{base:'repeat(1,1fr)',sm:'repeat(2,1fr)',md:'repeat(3, 1fr)'}} gap={6}>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        ...
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        <Text as={"b"} fontSize={"2xl"}>Insurance</Text>
                        <Text fontSize={"l"}>Insurance in State Insurance Company provides an opportunity to cover all costs of treatment, visits to the hospital and healthcare facilities, test and diagnostics.</Text>
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        <Text as={"b"} fontSize={"2xl"}>Exam Preparation</Text>
                        <Text fontSize={"l"}>Our accredited TOEFL Preparation courses and academic English exam preparation course will help you develop your test skills and improve your English level for exam success.</Text>
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        <Text as={"b"} fontSize={"2xl"}>Accompanying a student</Text>
                        <Text fontSize={"l"}>Full support of the student in the process of admission from the selection of an educational institution abroad to obtaining a student visa and organization of travel abroad.</Text>
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        <Text as={"b"} fontSize={"2xl"}>Admission on TOP universities</Text>
                        <Text fontSize={"l"}>All stages of admission are important: from choosing an educational institution to obtaining a visa. Therefore, we want to go through the enrollment process together with you, saving your valuable time and doing our favorite work</Text>
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
                    <GridItem p={"2%"} borderRadius={"5px"} border={"3px solid #4787f3"} className='education' w='100%' h='100%' bg='white' color={"#4787f3"}>
                        <Text as={"b"} fontSize={"2xl"}>Writing an ESSAY</Text>
                        <Text fontSize={"l"}>You prepare for tests, draw up your thoughts in motivational letters and essays under close guidance of ours. This stage ends submission of documets to the admission to the admission office</Text>
                        <Flex justifyContent={"flex-end"} w={"90%"} m={"auto"} mt={"2%"}><ArrowForwardIcon boxSize={"5"} /></Flex>
                    </GridItem>
